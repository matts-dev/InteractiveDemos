...
namespace TutorialEngine //not header only
{
	struct LineRenderer;
	class VisualVector;

	class VectorGridLines : public Engine::GameObjectBase	
	{
		using Parent = Engine::GameObjectBase;
	public:
	...
	public:
		...
		Engine::Curve<200> animCurve = Engine::CurveSystem::get().generateSigmoid_medp(100.f);
