// #include "RenderPrimitives/InteractiveMatrix.h"
...
namespace TutorialEngine
{
	...
	/*static*/ sp<Engine::Montserrat_BMF> Scalar_3D::font;
	...
	// Scalar_3D
	////////////////////////////////////////////////////////
	static volatile float warning_suppressor = 0.f;
	...
	void Scalar_3D::render(float dt_sec, const glm::mat4& projection, const glm::mat4& view)
	{
		...
		warning_suppressor += dt_sec; //suppressing warning of unused parameter during port... can delete later but fixing a LOT of issues atm, and don't need to bother with minor things like this.
	}

	void Scalar_3D::postConstruct()
	{
		Engine::GameObjectBase::postConstruct();

		font = !font ? new_sp<Engine::Montserrat_BMF>("./assets/textures/font/Montserrat_ss_alpha_1024x1024_wb.png") : font;
		text3D = new_sp<Engine::TextBlockSceneNode>(font, "NoValue");
	}
