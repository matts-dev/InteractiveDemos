...
{
	/*static*/ sp<TutorialEngine::LineRenderer> VectorGridLines::lineRenderer;
	...
	static volatile int warning_suppressor = 0;

	void VectorGridLines::render(const glm::mat4& projection_view, std::optional<glm::vec3> cameraPos)
	{
		using namespace glm;

		warning_suppressor += cameraPos.has_value();//remove unused variable warning... as I am porting this over.
