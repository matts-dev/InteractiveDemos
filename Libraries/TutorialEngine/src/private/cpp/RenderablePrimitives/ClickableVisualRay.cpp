...
namespace TutorialEngine
{
	...
	static volatile float warnining_suppressor = 0.f;
	void ClickableVisualRay::tick(float dt_sec)
	{
		...
		warnining_suppressor += dt_sec; //suppressing warning of unused parameter during port... can delete later but fixing a LOT of issues atm, and don't need to bother with minor things like this.
	}
